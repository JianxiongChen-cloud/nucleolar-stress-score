...
analyze_timepoint <- function(expr_mat, sample_vec, prefix,
  ...
  # At least 3/4 in the same direction (fallback, more permissive)
...
# Information on merging common genes at various time points
...
# Determine if the directions of common genes are consistent
...
# Extracting common up- and down-regulated genes
