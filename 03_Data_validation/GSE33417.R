...
############################################################
## 3. Construct sample annotation information
##    based on GSM sample names
############################################################
...
## Reorder according to the expression matrix sample order
...
############################################################
## 5. Convert expression matrix gene symbols to uppercase
...
############################################################
## 6. Calculate NuS scores using ssGSEA
############################################################
param <- ssgseaParam(
...
############################################################
## 7. Perform statistics separately for each cell type:
##    one-way ANOVA + Dunnett test versus 0 min
############################################################
...
############################################################
## 8. Generate separate plots:
##    one for iPS and one for HFF
############################################################
fill_colors <- c(
  "0"   = "#C4E7C1",
  "15"  = "#B7E0C6",
