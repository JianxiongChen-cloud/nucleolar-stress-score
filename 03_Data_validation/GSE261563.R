...
run_nus_ssgsea_tpm <- function(expr_sub, group_info, prefix) {
  ...
  ##########################################################
  ## 4.3 Remove zero-variance genes
  ##########################################################
  ...
  ##########################################################
  ## 4.4 Convert gene symbols to uppercase
...
############################################################
## 7. Merge score results from both subsets
############################################################
...
############################################################
## 8. Plot all groups in a single figure
############################################################
fill_colors <- c(
  "Control_543" = "#C4E7C1",
  "CX5461_543"  = "#51B3D1",
