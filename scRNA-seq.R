...
## 目的：
## - 在 epithelial cells 内，按 NuStress 和 RiboSis 的上下四分位数定义四象限
## - 识别不同象限对应的异常表达特征和潜在新信号
## - 重点比较：
##   1) NuS_high / Ribo_high vs NuS_low / Ribo_low：总体异常状态
##   2) NuS_low / Ribo_high vs NuS_low / Ribo_low：偏高 ribosome biogenesis 程序
##   3) NuS_high / Ribo_low vs NuS_low / Ribo_low：偏高 nucleolar stress 程序
###############################################################################
