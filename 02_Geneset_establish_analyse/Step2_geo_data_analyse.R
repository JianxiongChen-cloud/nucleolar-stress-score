...
## subdir is relative to input_dir
############################################################
...
############################################################
## 2. Read and clean a single dataset
############################################################
...
############################################################
## 5. Cross-dataset conflict genes
############################################################
...
############################################################
## 6. Remove cross-dataset conflict genes and retain consistent-trend genes
############################################################
...
############################################################
## 7. Frequency statistics of consistent-trend genes
############################################################
...
############################################################
## Supplementary. Plot frequency distribution histograms for upregulated and downregulated genes separately
############################################################
up_freq <- subset(gene_freq_consistent, group == "UP")
down_freq <- subset(gene_freq_consistent, group == "DOWN")

# Use a unified x-axis range for easier comparison
max_freq <- max(gene_freq_consistent$freq, na.rm = TRUE)
breaks_seq <- seq(0.5, max_freq + 0.5, by = 1)

# Histogram of upregulated gene frequencies
pdf(
...
# Histogram of downregulated gene frequencies
pdf(
...
############################################################
## Supplementary. Discrete frequency barplots suitable for publication figures
############################################################
...
############################################################
## 8. Final consistent up/down gene lists and statistics
############################################################
...
############################################################
## 9. Database-derived high-confidence genes: supported by at least 4 datasets
############################################################
...
############################################################
## 10. Dataset-treatment annotation table
############################################################
...
############################################################
## 11. Database-derived core genes
## Criteria: at least 5 datasets + at least 2 different inhibitors
############################################################
freq_cutoff_core <- 5
...
############################################################
## 12. Support table for database-derived core genes
############################################################
...
############################################################
## 13. Read literature-derived high-confidence and core genes
## These files are located in the current working directory: geneset
############################################################
...
############################################################
## 14. Merge function: literature + database, followed by conflict removal
############################################################
...
############################################################
## 15. Generate the nucleolar stress gene set: NuStress
############################################################
...
############################################################
## 16. Generate the core nucleolar stress gene set: NuStressCore
############################################################
...
############################################################
## Supplementary. Generate UpSet plots for NuStress and NuStressCore
## Purpose: visualize the source composition of genes retained in the final gene sets
############################################################
library(UpSetR)

# Convert gene lists into a binary matrix required by UpSetR
...
# Build a source annotation table for tracing the origin of each final gene
...
############################################################
## Supplementary 1. NuStress global gene set:
## Generate source UpSet plot using only the final retained genes
############################################################
...
# Export detailed source annotation table
...
############################################################
## Supplementary 2. NuStressCore gene set:
## Generate source UpSet plot using only the final retained genes
############################################################
